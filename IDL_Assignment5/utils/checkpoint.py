...
def load_checkpoint(unet, scheduler=None, vae=None, class_embedder=None, optimizer=None, checkpoint_path='checkpoints/checkpoint.pth'):
    print("loading checkpoint")
    checkpoint = torch.load(checkpoint_path, weights_only=False)
    
    print("loading unet")
    unet.load_state_dict(checkpoint['unet_state_dict'])
    # Remove or comment out scheduler loading
...
def save_checkpoint(unet, scheduler=None, vae=None, class_embedder=None, optimizer=None, epoch=None, save_dir='checkpoints'):
    ...
    checkpoint = {
        ...
        # Remove or comment out scheduler saving
