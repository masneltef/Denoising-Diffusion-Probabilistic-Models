...
class DDIMScheduler(DDPMScheduler):    
    ...
    def _get_variance(self, t):
        ...
        # σ_t^2 = ((1 - α_{t-1}) / (1 - α_t)) * (1 - α_t / α_{t-1})
    ...
    def step(
        ...
        # σ_t = eta * sqrt( ((1 - α_{t-1}) / (1 - α_t)) * (1 - α_t / α_{t-1}) )
        variance = ((1 - alpha_prod_t_prev) / (1 - alpha_prod_t)) * (1 - alpha_prod_t / alpha_prod_t_prev)
        ...
        pred_sample_direction = torch.sqrt(alpha_prod_t_prev) * (
            (sample - torch.sqrt(alpha_prod_t) * pred_epsilon) / torch.sqrt(1 - alpha_prod_t)
        )
